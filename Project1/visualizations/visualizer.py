...
TEMPLATE_OUTPUT_PATH: Final = 'db_storage/templates/'

class Visualizer:
    matplotlib.use('Agg')
    def __init__(self, country_name: str, movies=None, mask_path: str = None, template_path: str = "visualizations/templates/"):
