...
class Visualizer():
    ...
    def visualize_TOPK(self, k: int = 5) -> None:
        """
        ...
        self.save_movies_html(movie_cards=movie_cards)
    ...
    def visualize_piechart(self, k: int=8) -> None:
        ...
        top_genres = dict(genre_counts.most_common(k)) # 상위 top_n개의 장르 추출
    ...
    def save_movies_html(self, movie_cards: str) -> None:
        """
        영화 HTML 리스트를 저장
        """
        html_content = f"""
    ...
    def save_wordcloud_to_html(self, wordcloud: WordCloud, title: str="Word Cloud") -> str:
        """
    ...
    def save_pichart_to_html(self, top_genres: dict):    
       # 파이 차트 생성
    ...
    def save_average_rating_to_html(self, average_rating: float):
    ...
    def convert_to_base64(self, fig=None, format="png", dpi=300, bbox_inches="tight") -> str:
        """
